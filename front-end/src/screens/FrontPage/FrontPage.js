...
import main_image11 from '../../images/main_image11.jpg';
import main_image12 from '../../images/main_image12.jpg';
...
const FrontPage = () => {
  ...
  return (
    <MainContainer>
     <BackgroundSlider
          images={[main_image0,main_image1, main_image11, main_image12, main_image4, main_image10]}
          duration={3}
          transition={0.1}
        />
      <NavBar>
